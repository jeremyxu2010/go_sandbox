...
type Middleware func(profilesvcapi.Service) profilesvcapi.Service

func LoggingMiddleware(logger log.Logger) Middleware {
	return func(next profilesvcapi.Service) profilesvcapi.Service {
...
type loggingMiddleware struct {
	next   profilesvcapi.Service
	logger log.Logger
}

func (mw loggingMiddleware) PostProfile(ctx context.Context, p profilesvcapi.Profile) (err error) {
...
func (mw loggingMiddleware) GetProfile(ctx context.Context, id string) (p profilesvcapi.Profile, err error) {
	defer func(begin time.Time) {
...
func (mw loggingMiddleware) PutProfile(ctx context.Context, id string, p profilesvcapi.Profile) (err error) {
	defer func(begin time.Time) {
...
func (mw loggingMiddleware) PatchProfile(ctx context.Context, id string, p profilesvcapi.Profile) (err error) {
	defer func(begin time.Time) {
...
func (mw loggingMiddleware) GetAddresses(ctx context.Context, profileID string) (addresses []profilesvcapi.Address, err error) {
	defer func(begin time.Time) {
...
func (mw loggingMiddleware) GetAddress(ctx context.Context, profileID string, addressID string) (a profilesvcapi.Address, err error) {
	defer func(begin time.Time) {
...
func (mw loggingMiddleware) PostAddress(ctx context.Context, profileID string, a profilesvcapi.Address) (err error) {
	defer func(begin time.Time) {
